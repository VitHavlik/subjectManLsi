...
let dtoIn = {
  ...
  test("subject/get - Error 2.2.1 ", async () => {
    ...
    result = await TestHelper.executeGetCommand("subject/get", {id: result.id, unsupportedKey: "Ve středu bude pršet"})
  ...
  // test("subject/listByStudyProgramme - HDS", async () => {
  //   expect.assertions(9)
  //   let dtoIn = {
        
  //           studyProgrammeId: "61e3df0e3fd55d2a50e55c82"
